...
/**
 * A parameter set with relaxed settings. The speed is less and the waiting times are higher. This can be used to model
 * evacuation tests, where people usually tend to not leave the building as fast as possible.
 *
...
public class TestEvacuationParameterSet extends DefaultParameterSet {
    ...
    /**
     * Returns a random reaction time. The reaction time is independendly selected from the age. The same result as
     * {@link #getReactionTime()}
     *
