...
//coveredDistance
   ...
   * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual
  ...
  public double getCoveredDistance( Individual ind, int t ) throws OneIndNoPotentialException, IncorrectTimeException {
    ...
    if( ind.getDeathCause() != null && ind.getDeathCause().compareTo(org.zet.cellularautomaton.DeathCause.EXIT_UNREACHABLE ) == 0 ) {
   ...
   * has no static potential (there`s no exit reachable from the individual's
   * position)
   * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "from" is bigger
   ...
   * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all
   * individuals have no potential
   * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "time" is less
   * than 0
   */
   ...
   * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoValueBecauseAlreadySafeException if
   * "t" is bigger than the individual's safetyTime
   * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual
   * has no static potential (there`s no exit reachable from the individual's
   * position)
   * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "t" is less than 0
   * @throws org.zet.cellularautomaton.statistic.exception.MissingStoredValueException if the
   ...
   * has no static potential (there`s no exit reachable from the individual's
   * position)
   * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "time" is less or
   * equal 0
   * @throws org.zet.cellularautomaton.statistic.exception.MissingStoredValueException if the
   * individual had no speedvalue in timestep 1
   */
   ...
   * has no static potential (there`s no exit reachable from the individual's
   * position)
   * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "from" is less or
   ...
   * 0 if all individuals have no static potential (there`s no exit
   * reachable from the individual's positions)
   * @see #calculateAverageSpeed
   * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "time" is less or
   * equal 0
   * @throws org.zet.cellularautomaton.statistic.exception.MissingStoredValueException if at least one
   * individual had no speedvalue in timestep 1
   * @throws
   * org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoValueBecauseAlreadySafeException if at
   ...
   * reachable from the individual's positions)
   * @see #getCurrentSpeed
   * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "timestep" is less
   * than 0
   * @throws org.zet.cellularautomaton.statistic.exception.MissingStoredValueException if at least one
   * individual had no speedvalue in timestep 1
   * @throws
   ...
   * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if the given
   ...
   * 0 if the first stored value for the individual lies after the
   * timestep "t"
   * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoValueBecauseAlreadySafeException if
   * "t" is bigger than the individual's safetyTime
   * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual
   ...
   * exitcell
   * @throws org.zet.cellularautomaton.statistic.exception.OneIndNotSafeException if the individual has
   ...
   * @see #getSafetyTime
   * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNotSafeException if all
