...
import org.zet.cellularautomaton.statistic.exception.GroupOfIndsNotSafeException;
import org.zet.cellularautomaton.statistic.exception.IncorrectTimeException;
import org.zet.cellularautomaton.statistic.exception.MissingStoredValueException;
import org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException;
import org.zet.cellularautomaton.statistic.exception.OneIndNoValueBecauseAlreadySafeException;
import org.zet.cellularautomaton.statistic.exception.OneIndNotSafeException;
...
//coveredDistance
     ...
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "t" is less than 0
     */
     ...
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     * potential (there`s no exit reachable from the individual's position)
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "from" is bigger than "to" OR
     * "from" is less than 0 OR "to" is less than 0
     */
     ...
     * @return the average of the individual's covered distances from the beginning of the simulation to TimeStep "time"
     * (this value is calculated only over those individuals which have a potential)
     * @see #getCoveredDistance
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * potential
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "time" is less than 0
     */
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average of the individual's covered distances from the TimeStep "from" to the TimeStep "to" (this
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return a list of averages of the individual's covered distances from the TimeStep 0 to the TimeStep ("from"+i),
     * whereas i is the index of the value in the list and i runs from 0 to (to-from) (this values are calculated only
     ...
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoValueBecauseAlreadySafeException if "t" is bigger
     * than the individual's safetyTime
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     * potential (there`s no exit reachable from the individual's position)
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "t" is less than 0
     * @throws org.zet.cellularautomaton.statistic.exception.MissingStoredValueException if the individual had no
     ...
     * @param ind an individual
     * @param time a TimeStep
     * @return the average speed of the individual from the beginning of the simulation to TimeStep "time" (if the
     * TimeStep "time" is later than the individual's SafetyTime, this time is taken instead of "time")
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoValueBecauseAlreadySafeException if the individual
     * is already safe in timestep 1
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     * potential (there`s no exit reachable from the individual's position)
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "time" is less or equal 0
     * @throws org.zet.cellularautomaton.statistic.exception.MissingStoredValueException if the individual had no
     * speedvalue in timestep 1
     */
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average speed of the individual from the TimeStep "from" to the TimeStep "to" (if the TimeStep "to"
     * is later than the individual's SafetyTime, this time is taken instead of "to")
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoValueBecauseAlreadySafeException if the individual
     * is already safe in timestep "from"
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     * potential (there`s no exit reachable from the individual's position)
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "from" is less or equal 0 OR "to"
     * is less or equal 0 OR "from" is bigger than the original "to"
     * @throws org.zet.cellularautomaton.statistic.exception.MissingStoredValueException if the individual had no
     * speedvalue in timestep 1
     */
     ...
     * @param ind an individual
     * @param time a TimeStep
     * @return the maximum speed of the individual from the beginning of the simulation to TimeStep "time" (if the
     * TimeStep "time" is later than the individual's SafetyTime, this time is taken instead of "time")
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoValueBecauseAlreadySafeException if the individual
     * is already safe in timestep 1
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the maximum speed of the individual from the TimeStep "from" to the TimeStep "to" (if the TimeStep "to"
     * is later than the individual's SafetyTime, this time is taken instead of "to")
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoValueBecauseAlreadySafeException if the individual
     * is already safe in timestep "from"
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the average of the individual's average-speeds from the beginning of the simulation to TimeStep "time"
     * (this value is calculated only over those individuals which have a potential and are not safe in timestep from) 0
     * if all individuals have no static potential (there`s no exit reachable from the individual's positions)
     * @see #calculateAverageSpeed
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "time" is less or equal 0
     * @throws org.zet.cellularautomaton.statistic.exception.MissingStoredValueException if at least one individual had
     * no speedvalue in timestep 1
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoValueBecauseAlreadySafeException if at least
     * one individual is already safe in timestep 1 AND all other individuals have no static potential or are already
     * safe in timestep 1
     */
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average of the individual's average-speeds from the TimeStep "from" to the TimeStep "to" (this value
     * is calculated only over those individuals which have a potential and are not safe in timestep from)
     * @return 0 if all individuals have no static potential (there`s no exit reachable from the individual's positions)
     * @see #calculateAverageSpeed
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "from" is less or equal 0 OR "to"
     * is less or equal 0 OR "from" is bigger than the original "to"
     * @throws org.zet.cellularautomaton.statistic.exception.MissingStoredValueException if at least one individual had
     * no speedvalue in timestep 1
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoValueBecauseAlreadySafeException if at least
     * one individual is already safe in timestep "from" AND all other individuals have no static potential or are
     * already safe in timestep from
     */
     ...
     * @return the average of the individual's speeds in timeStep "timestep" (this value is calculated only over those
     * individuals which have a potential and are not safe in timestep "timestep") 0 if all individuals have no static
     * potential (there`s no exit reachable from the individual's positions)
     * @see #getCurrentSpeed
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "timestep" is less than 0
     * @throws org.zet.cellularautomaton.statistic.exception.MissingStoredValueException if at least one individual had
     * no speedvalue in timestep 1
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoValueBecauseAlreadySafeException if at least
     * one individual is already safe in timestep "timestep" AND all other individuals have no static potential or are
     * already safe in timestep "timestep"
     */
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the average of the individual's maximum-speeds from the beginning of the simulation to TimeStep "time"
     * (this value is calculated only over those individuals which have a potential and are not safe in timestep from) 0
     * if all individuals have no static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average of the individual's maximum-speeds from the TimeStep "from" to the TimeStep "to" (this value
     * is calculated only over those individuals which have a potential and are not safe in timestep from) 0 if all
     * individuals have no static potential (there`s no exit reachable from the individual's positions)
     * @see #calculateMaxSpeed
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "from" is less or equal 0 OR "to"
     * is less or equal 0 OR "from" is bigger than the original "to"
     * @throws org.zet.cellularautomaton.statistic.exception.MissingStoredValueException if at least one individual had
     ...
     * @param indgroup a list of individuals
     * @param timestep a TimeStep
     * @return the maximum of the individual's speeds in timeStep "timestep" (this value is calculated only over those
     * individuals which have a potential and are not safe in timestep "timestep") 0 if all individuals have no static
     * potential (there`s no exit reachable from the individual's positions)
     * @see #getCurrentSpeed
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "timestep" is less than 0
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the maximum of the individual's maximum-speeds from the beginning of the simulation to TimeStep "time"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateMaxSpeed
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if the given TimeStep(s) is/are less
     * than 0 or are in wrong order
     */
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the maximum of the individual's maximum-speeds from the TimeStep "from" to the TimeStep "to" (this value
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the maximum of the individual's average-speeds from the beginning of the simulation to TimeStep "time"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateAverageSpeed
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the maximum of the individual's average-speeds from the TimeStep "from" to the TimeStep "to" (this value
     * is calculated only over those individuals which have a potential)
     * @see #calculateAverageSpeed
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the minimum of the individual's average-speeds from the beginning of the simulation to TimeStep "time"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateAverageSpeed
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the minimum of the individual's average-speeds from the TimeStep "from" to the TimeStep "to" (this value
     * is calculated only over those individuals which have a potential)
     * @see #calculateAverageSpeed
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param ind an individual
     * @param t a TimeStep
     * @return the individuals exhaustion in TimeStep "t" 0 if the first stored value for the individual lies after the
     * timestep "t"
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoValueBecauseAlreadySafeException if "t" is bigger
     * than the individual's safetyTime
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     ...
     * @param ind an individual
     * @param time a TimeStep
     * @return the average exhaustion of the individual from the beginning of the simulation to TimeStep "time" (if the
     * TimeStep "to" is later than the individual's SafetyTime, this time is taken instead of "to")
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     * potential (there`s no exit reachable from the individual's position)
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if the given TimeStep(s) is/are less
     * than 0 or are in wrong order
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average exhaustion of the individual from the TimeStep "from" to the TimeStep "to" (if the TimeStep
     * "to" is later than the individual's SafetyTime, this time is taken instead of "to")
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     * potential (there`s no exit reachable from the individual's position)
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if the given TimeStep(s) is/are less
     ...
     * @param ind an individual
     * @param time a TimeStep
     * @return the maximum exhaustion of the individual from the beginning of the simulation to TimeStep "time" (if the
     * TimeStep "to" is later than the individual's SafetyTime, this time is taken instead of "to")
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     * potential (there`s no exit reachable from the individual's position)
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if the given TimeStep(s) is/are less
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the maximum exhaustion of the individual from the TimeStep "from" to the TimeStep "to" (if the TimeStep
     * "to" is later than the individual's SafetyTime, this time is taken instead of "to")
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     * potential (there`s no exit reachable from the individual's position)
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if the given TimeStep(s) is/are less
     ...
     * @param ind an individual
     * @param time a TimeStep
     * @return the minimum exhaustion the individual had from the beginning of the simulation to TimeStep "time" except
     * for the exhaustion at the beginning of the simulation (if the individual never had a higher exhaustion than that
     * at the beginning of the simulation, this value is returned) (if the TimeStep "to" is later than the individual's
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the minimum exhaustion the individual had from the TimeStep "from" to the TimeStep "to" except for the
     * exhaustion at the beginning of the simulation (if the individual never had a higher exhaustion than that at the
     * beginning of the simulation, this value is returned) (if the TimeStep "to" is later than the individual's
     * SafetyTime, this time is taken instead of "to")
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     * potential (there`s no exit reachable from the individual's position)
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if the given TimeStep(s) is/are less
     ...
     * @param indgroup a list of individuals
     * @param t a TimeStep
     * @return the average of the individual's exhasutionvalues in TimeStep "t" (this value is calculated only over
     * those individuals which have a potential and are not safe in timestep "timestep")
     * @return 0 if all individuals have no static potential (there`s no exit reachable from the individual's positions)
     * OR if all individual's first stored values lie after the timestep "t"
     * @see #getExhaustion
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "timestep" is less than 0
     * @throws org.zet.cellularautomaton.statistic.exception.MissingStoredValueException if at least one individual had
     * no speedvalue in timestep 1
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the average of the individual's average-exhaustions from the beginning of the simulation to TimeStep
     * "time" (this value is calculated only over those individuals which have a potential)
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average of the individual's average-exhaustions from the TimeStep "from" to the TimeStep "to" (this
     * value is calculated only over those individuals which have a potential)
     * @see #calculateAverageExhaustion
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the average of the individual's maximum-exhaustions from the beginning of the simulation to TimeStep
     * "time" (this value is calculated only over those individuals which have a potential)
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average of the individual's maximum-exhaustions from the TimeStep "from" to the TimeStep "to" (this
     * value is calculated only over those individuals which have a potential)
     * @see #calculateMaxExhaustion
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the average of the individual's minimum-exhaustions from the beginning of the simulation to TimeStep
     * "time" (this value is calculated only over those individuals which have a potential)
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average of the individual's minimum-exhaustions from the TimeStep "from" to the TimeStep "to" (this
     * value is calculated only over those individuals which have a potential)
     * @see #calculateMinExhaustionExceptingStartExhaustion
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the maximum of the individual's average-exhaustions from the beginning of the simulation to TimeStep
     * "time" (this value is calculated only over those individuals which have a potential)
     * @see #calculateAverageExhaustion
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the maximum of the individual's average-exhaustions from the TimeStep "from" to the TimeStep "to" (this
     * value is calculated only over those individuals which have a potential)
     * @see #calculateAverageExhaustion
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException
     */
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the maximum of the individual's maximum-exhaustions from the beginning of the simulation to TimeStep
     * "time" (this value is calculated only over those individuals which have a potential)
     * @see #calculateMaxExhaustion
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the maximum of the individual's maximum-exhaustions from the TimeStep "from" to the TimeStep "to" (this
     * value is calculated only over those individuals which have a potential)
     * @see #calculateMaxExhaustion
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the minimum of the individual's average-exhaustions from the beginning of the simulation to TimeStep
     * "time" (this value is calculated only over those individuals which have a potential)
     * @see #calculateAverageExhaustion
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the minimum of the individual's average-exhaustions from the TimeStep "from" to the TimeStep "to" (this
     * value is calculated only over those individuals which have a potential)
     * @see #calculateAverageExhaustion
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the minimum of the individual's minimum-exhaustions from the beginning of the simulation to TimeStep
     * "time" (this value is calculated only over those individuals which have a potential)
     * @see #calculateMinExhaustionExceptingStartExhaustion
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the minimum of the individual's minimum-exhaustions from the TimeStep "from" to the TimeStep "to" (this
     * value is calculated only over those individuals which have a potential)
     * @see #calculateMinExhaustionExceptingStartExhaustion
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @return 0 if the first stored value for the individual lies after the timestep "t"
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoValueBecauseAlreadySafeException if "t" is bigger
     * than the individual's safetyTime
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     * potential (there`s no exit reachable from the individual's position)
     ...
     * @param ind an individual
     * @param time a TimeStep
     * @return the average panic of the individual from the beginning of the simulation to TimeStep "time" (if the
     * TimeStep "to" is later than the individual's SafetyTime, this time is taken instead of "to")
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     * potential (there`s no exit reachable from the individual's position)
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if the given TimeStep(s) is/are less
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average panic of the individual from the TimeStep "from" to the TimeStep "to" (if the TimeStep "to"
     * is later than the individual's SafetyTime, this time is taken instead of "to")
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     * potential (there`s no exit reachable from the individual's position)
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if the given TimeStep(s) is/are less
     ...
     * @param ind an individual
     * @param time a TimeStep
     * @return the maximum panic of the individual from the beginning of the simulation to TimeStep "time" (if the
     * TimeStep "to" is later than the individual's SafetyTime, this time is taken instead of "to")
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     * potential (there`s no exit reachable from the individual's position)
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if the given TimeStep(s) is/are less
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the maximum panic of the individual from the TimeStep "from" to the TimeStep "to" (if the TimeStep "to"
     * is later than the individual's SafetyTime, this time is taken instead of "to")
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     * potential (there`s no exit reachable from the individual's position)
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if the given TimeStep(s) is/are less
     ...
     * @param ind an individual
     * @param time a TimeStep
     * @return the minimum panic the individual had from the beginning of the simulation to TimeStep "time" except for
     * the panic at the beginning of the simulation (if the individual never had a higher panic than that at the
     * beginning of the simulation, this value is returned) (if the TimeStep "to" is later than the individual's
     * SafetyTime, this time is taken instead of "to")
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     * potential (there`s no exit reachable from the individual's position)
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the minimum panic the individual had from the TimeStep "from" to the TimeStep "to" except for the panic
     * at the beginning of the simulation (if the individual never had a higher panic than that at the beginning of the
     * simulation, this value is returned) (if the TimeStep "to" is later than the individual's SafetyTime, this time is
     * taken instead of "to")
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     * potential (there`s no exit reachable from the individual's position)
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if the given TimeStep(s) is/are less
     ...
     * @param indgroup a list of individuals
     * @param t a TimeStep
     * @return the average of the individual's panicvalues in TimeStep "t" (this value is calculated only over those
     * individuals which have a potential and are not safe in timestep "timestep")
     * @return 0 if all individuals have no static potential (there`s no exit reachable from the individual's positions)
     * OR if all individual's first stored values lie after the timestep "t"
     * @see #getPanic
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "timestep" is less than 0
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the average of the individual's average-panics from the beginning of the simulation to TimeStep "time"
     * (this value is calculated only over those individuals which have a potential)
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average of the individual's average-panics from the TimeStep "from" to the TimeStep "to" (this value
     * is calculated only over those individuals which have a potential)
     * @see #calculateAveragePanic
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the average of the individual's maximum-panics from the beginning of the simulation to TimeStep "time"
     * (this value is calculated only over those individuals which have a potential)
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average of the individual's maximum-panics from the TimeStep "from" to the TimeStep "to" (this value
     * is calculated only over those individuals which have a potential)
     * @see #calculateMaxPanic
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the average of the individual's minimum-panics from the beginning of the simulation to TimeStep "time"
     * (this value is calculated only over those individuals which have a potential)
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average of the individual's minimum-panics from the TimeStep "from" to the TimeStep "to" (this value
     * is calculated only over those individuals which have a potential)
     * @see #calculateMinPanicExceptingStartPanic
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the maximum of the individual's average-panics from the beginning of the simulation to TimeStep "time"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateAveragePanic
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the maximum of the individual's average-panics from the TimeStep "from" to the TimeStep "to" (this value
     * is calculated only over those individuals which have a potential)
     * @see #calculateAveragePanic
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the maximum of the individual's maximum-panics from the beginning of the simulation to TimeStep "time"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateMaxPanic
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the maximum of the individual's maximum-panics from the TimeStep "from" to the TimeStep "to" (this value
     * is calculated only over those individuals which have a potential)
     * @see #calculateMaxPanic
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the minimum of the individual's average-panics from the beginning of the simulation to TimeStep "time"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateAveragePanic
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the minimum of the individual's average-panics from the TimeStep "from" to the TimeStep "to" (this value
     * is calculated only over those individuals which have a potential)
     * @see #calculateAveragePanic
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the minimum of the individual's minimum-panics from the beginning of the simulation to TimeStep "time"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateMinPanicExceptingStartPanic
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the minimum of the individual's minimum-panics from the TimeStep "from" to the TimeStep "to" (this value
     * is calculated only over those individuals which have a potential)
     * @see #calculateMinPanicExceptingStartPanic
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * static potential (there`s no exit reachable from the individual's positions)
     ...
     *
     * @param indgroup a list of individuals
     * @return the average of the individual's minDistanceToNearestExit (this value is calculated only over those
     ...
     *
     * @param indgroup a list of individuals
     * @return the average of the individual's minDistanceToPlannedExit (this value is calculated only over those
     * individuals which have a potential)
     ...
     * @param ind an individual
     * @param time a TimeStep
     * @return the difference between the individual's minDistanceToPlannedExit and the distance which the individual
     * had covered until TimeStep "time"
     * @see #minDistanceToPlannedExit
     * @see #getCoveredDistance
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     * potential (there`s no exit reachable from the individual's position)
     ...
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNotSafeException if the individual has never entered
     * a save- or exitcell
     */
     ...
     *
     * @param indgroup a list of individuals
     * @return the average of the numbers of TimeSteps in which the individuals first entered a save- or exitcell (this
     * value is calculated only over those individuals which are safe at the end of the simulation)
     * @see #getSafetyTime
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNotSafeException if all individuals have no
     * safetyTime
     */
     ...
     * @param ind an individual
     * @param t a TimeStep
     * @return the number of TimeSteps in which the individual waited (=all neighbourcells were occupied by other
     * individuals) from the beginning of the simulation to TimeStep "time"
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     * potential (there`s no exit reachable from the individual's position)
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "t" is less than 0
     */
     ...
     * @param to a TimeStep
     * @return the number of TimeSteps in which the individual waited (=all neighbourcells were occupied by other
     * individuals) from the TimeStep "from" to the TimeStep "to"
     *
     * @throws org.zet.cellularautomaton.statistic.exception.OneIndNoPotentialException if the individual has no static
     * potential (there`s no exit reachable from the individual's position)
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "from" is bigger than "to" OR
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the average of the numbers of TimeSteps in which the individuals waited from the beginning of the
     * simulation to TimeStep "time" (this value is calculated only over those individuals which have a potential)
     * @see #getWaitedTime
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * potential
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "time" is less than 0
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average of the numbers of TimeSteps in which the individuals waited from the TimeStep "from" to the
     * TimeStep "to" (this value is calculated only over those individuals which have a potential)
     * @see #getWaitedTime
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * potential
     * @throws org.zet.cellularautomaton.statistic.exception.IncorrectTimeException if "from" is bigger than "to" OR
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the maximum of the numbers of TimeSteps in which the individuals waited from the beginning of the
     * simulation to TimeStep "time" (this value is calculated only over those individuals which have a potential)
     * @see #getWaitedTime
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * potential
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the maximum of the numbers of TimeSteps in which the individuals waited from the TimeStep "from" to the
     * TimeStep "to" (this value is calculated only over those individuals which have a potential)
     * @see #getWaitedTime
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * potential
     ...
     * @param indgroup a list of individuals
     * @param time a TimeStep
     * @return the minimum of the numbers of TimeSteps in which the individuals waited from the beginning of the
     * simulation to TimeStep "time" (this value is calculated only over those individuals which have a potential)
     * @see #getWaitedTime
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * potential
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the minimum of the numbers of TimeSteps in which the individuals waited from the TimeStep "from" to the
     * TimeStep "to" (this value is calculated only over those individuals which have a potential)
     * @see #getWaitedTime
     * @throws org.zet.cellularautomaton.statistic.exception.GroupOfIndsNoPotentialException if all individuals have no
     * potential
