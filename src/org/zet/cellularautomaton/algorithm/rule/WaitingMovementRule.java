    ...
    protected ArrayList<EvacCell> neighboursByPriority(EvacCell cell) {
        class CellPrioritySorter implements Comparator<EvacCell> {
            ...
            public int compare(EvacCell cell1, EvacCell cell2) {
                final double potential1 = es.getParameterSet().effectivePotential(referenceCell, cell1, es::getDynamicPotential);
                final double potential2 = es.getParameterSet().effectivePotential(referenceCell, cell2, es::getDynamicPotential);
