...
public abstract class AbstractRule implements Rule {
	...
	public void setEvacuationSimulationProblem( EvacuationSimulationProblem esp ) {
		if( this.esp != null )
			throw new RuntimeException( CellularAutomatonLocalization.LOC.getString( "algo.ca.rule.RuleAlreadyHaveCAControllerException" ) );

		if( esp == null )
			throw new RuntimeException( CellularAutomatonLocalization.LOC.getString( "algo.ca.rule.CAControllerIsNullException" ) );
