...
public class EvacuationCellularAutomatonInOrder extends EvacuationCellularAutomatonAlgorithm {
    ...
    public List<Individual> getIndividuals() {
        return getProblem().getCellularAutomaton().getIndividuals();
    }
...
//				fireProgressEvent( 0, String.format( "0 von %1$s Personen evakuiert.", getProblem().getCellularAutomaton().getInitialIndividualCount() ) );
